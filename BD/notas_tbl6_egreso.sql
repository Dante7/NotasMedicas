...
--
-- Table structure for table `tbl6_egreso`
--
...
--
-- Dumping data for table `tbl6_egreso`
--

LOCK TABLES `tbl6_egreso` WRITE;
/*!40000 ALTER TABLE `tbl6_egreso` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl6_egreso` ENABLE KEYS */;
UNLOCK TABLES;
