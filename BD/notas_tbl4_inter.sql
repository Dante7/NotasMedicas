...
--
-- Table structure for table `tbl4_inter`
--
...
--
-- Dumping data for table `tbl4_inter`
--

LOCK TABLES `tbl4_inter` WRITE;
/*!40000 ALTER TABLE `tbl4_inter` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl4_inter` ENABLE KEYS */;
UNLOCK TABLES;
