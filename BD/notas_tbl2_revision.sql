...
--
-- Table structure for table `tbl2_revision`
--
...
--
-- Dumping data for table `tbl2_revision`
--

LOCK TABLES `tbl2_revision` WRITE;
/*!40000 ALTER TABLE `tbl2_revision` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl2_revision` ENABLE KEYS */;
UNLOCK TABLES;
