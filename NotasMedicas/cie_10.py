...
class Tbl1Paciente(models.Model):
    ...
    fecha_nacimiento = models.CharField(max_length=405, blank=True)
    nombre = models.CharField(max_length=405)
    nss = models.CharField(max_length=405)
    estado = models.CharField(max_length=405)
    escolaridad = models.CharField(max_length=405, blank=True)
    religion = models.CharField(max_length=405, blank=True)
    ocupacion = models.CharField(max_length=405, blank=True)
    estado_civil = models.CharField(max_length=405, blank=True)
    tipo_interrogatorio = models.CharField(max_length=405, blank=True)
    status = models.CharField(max_length=405)
    cama = models.CharField(max_length=3705)
    class Meta:
...
class Tbl2Nota(models.Model):
    ...
    tipo_nota = models.CharField(max_length=405)
    descripcion = models.CharField(max_length=405)
    hospital = models.CharField(max_length=405)
    medico = models.CharField(max_length=405)
